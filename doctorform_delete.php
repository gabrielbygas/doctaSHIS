                  ...
                  <div class="chart tab-pane" id="sales-chart" style="position: relative; height: 300px;">
                    <canvas id="sales-chart-canvas" height="300" style="height: 300px;"></canvas>                         
                              ...
                              <div class="row">
                                    ...
                                    <?php
                                        //delete
                                        if( isset($_POST['doctor']) && $_POST['doctor']=="delete" ){
                                            
                                            $doctor->deleteDoctor($phone);
                                        ?>
                                            <br/> <br/>
                                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                            <strong>Doctor name's deleted</strong>
                                    ...
                                    ?>
                                            ...
                                            <div id="element">
                                        Do you really want to delete Doctor Mr. <?php $doctor->getDoctorId('nameD',$phone); ?> ? <br/>
                                                ...
                                                <center><button type="button" class="btn btn-danger " data-toggle="modal" data-target="#exampleModal">
                                                    ...
                                                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            Are you wishing to delete Doctor?
                                                            </div>
                                                            <div class="modal-footer">
                                                              <form action="doctorform_delete.php?ph=<?php echo $phone = $_GET['ph'];?>" method="POST"> 
                                                               ...
                                                               <!-- <button type="button" class="btn btn-secondary" data-dismiss="modal" name="no" value="no">NO, Close</button>
                                                                ...
                                                                -->
                                                                <input type="hidden" name="doctor" value="delete">
                                                              </form>
                                                            </div>
                                                        </div>
                                                        </div>
