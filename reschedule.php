<?php
  ...
  //if($schedule->getScheduleId('appointmentDate',1512151) <= '2000-01-01 00:00:00'){
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Reschedule Appointment</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <div class="card-header">
                <h3 class="card-title">
                 <i class="fas fa-calendar-alt"></i>&nbsp; &nbsp;
                  <h3 class="card-title">RESCHEDULE APPOINTMENT</h3>
                </h3>
                            ...
                            <div class="col-md-12">  
                                    ...
                                    <?php
                                      ...
                                      ?>
                                          ...
                                          <strong>Your appointment is changed.</strong>
                                    ...
                                    ?>  
                                        Mr. <?php 
                                            ...
                                            $schedule->getScheduleId('patientName',$_SESSION['studentNumber']); ?>, <br/>
                                        ...
                                        your appointment date of <?php $schedule->getScheduleId('appointmentDate',$_SESSION['studentNumber']); ?> ?
                                            ...
                                            <div class="form-group">
                                              ...
                                              <input type="date" class="form-control" name="appointmentDate" id="appointmentDate" placeholder="Appointment Date">
                                            </div>
                                            <div class="form-group">
                                              ...
                                              <input type="hidden" name="studentNumber" value="<?php echo $_SESSION['studentNumber'];?>">
                                              <input type="hidden" name="schedule" value="update">
