          ...
          <section class="col-lg-7 connectedSortable">
            ...
            <div class="card card-info">
              ...
              <div class="card-body">
                ...
                <?php
                  //add
                  if( isset($_POST['schedule']) && $_POST['schedule']=="update" ){
                    
                      
                      $schedule->updateAll($_POST);
                      if($schedule->update == TRUE){
                  ?>
                        <div class="alert alert-info alert-dismissible fade show" role="alert">
                          <strong>Appointment is updated.</strong>
                ...
                ?>
                              ...
                              <div class="row">
                                    <div class="col-md-12">  <!-- $student = $_GET['st']; -->
                                    <form action="edit_form.php?st=<?php echo $student = $_GET['st'];?>" method="POST">
                                      <div class="form-group">
                                        <label for="exampleInputEmail1">Select Doctor </label>
                                        <select class="form-control" id="Select1" name="doctorName">
                                        <option selected="" value="<?php $schedule->getScheduleId('doctorName',$student);?>"><?php $schedule->getScheduleId('doctorName',$student);?></option>
                                        <option value="Harmick">Harmick</option>
                                        <option value="Makiese">Makiese</option>
                                        <option value="Vangu">Vangu</option>
                                      </select>
                                      </div>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <select class="form-control" id="time" name="timeSchedule" > <!-- name="timeSchedule" -->
                                        <option selected="" value="<?php $schedule->getScheduleId('timeSchedule',$student);?>"><?php $schedule->getScheduleId('timeSchedule',$student);?></option>
                                      ...
                                      <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="patientName" id="name" placeholder="<?php $schedule->getScheduleId('patientName',$student);?>">
                                      </div>
                                      <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="studentNumber" id="studentNumber" placeholder="<?php $schedule->getScheduleId('studentNumber',$student);?>">
                                      </div>
                                      <div class="form-group">
                                            <label for="exampleFormControlSelect2">Patient Mobile</label>
                                            <input type="number" class="form-control" id="patientMobile" name="patientMobile" placeholder="<?php $schedule->getScheduleId('patientMobile',$student);?>">
                                          </div>

                                      <div class="form-group">
                                            <label for="exampleInputEmail1">Country </label>
                                            <select class="form-control" name="country" size="1">
                                            <option selected="" value="<?php $schedule->getScheduleId('country',$student);?>"><?php $schedule->getScheduleId('country',$student);?></option>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <select class="form-control" name="department" size="1">
                                          <option selected="" value="<?php $schedule->getScheduleId('department',$student);?>"><?php $schedule->getScheduleId('department',$student);?></option>
                                      ...
                                      <div class="form-check">
                                        <div class="row">
                                          ...
                                          <div class="col-md-6">
                                            ...
                                            <input class="" type="hidden" name="schedule" value="update">
