          ...
          <div class="col-lg-1">
            ...
            <div class="col-lg-10">
              <div class="m-portlet__body">
                ...
                <?php
                  //add
                  if( isset($_POST['announcement']) && $_POST['announcement']=="add" ){
                      $announcement = new Announcement;
                      $announcement->addAnnouncement($_POST);
                ...
                <h4>Write your message</h4>
                  ...
                  <div class="form-group m-form__group">
                    <textarea maxlength="500" id="chat_content" name="messageA" rows="10" class="form-control m-input"></textarea> 
                      <span id="chars_chat">Text area can only support 500 characters</span>     
                  </div>
                      
                      <input type="hidden" name="dateAnnouncement" value="<?php echo date("Y-m-d");?>">
                      <input type="hidden" name="announcement" value="add"> 
