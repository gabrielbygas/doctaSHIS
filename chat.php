  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
       <article class="medrepot_table.php">
        <div class="container">
          <div id="chat" class="tab-pane active">
            <div class="row">
              <div class="col-lg-6">
                ...
                <?php
                  if( isset($_POST['message']) && $_POST['message']=="add" ){
                    $message->addEnquiry($_POST);
                    if($message->add == TRUE){
                ?>
                <div class="alert alert-info alert-dismissible fade show" role="alert">
                    <strong>Question send.</strong>
                ...
                <div class="form-group m-form__group">
                        <textarea name="question" maxlength="1000" id="chat_content" rows="3" class="form-control m-input"></textarea> 
                        <span id="chars_chat">1000 characters only</span> 
               </div>
                    <input type="hidden" name="message" value="add">
                    <input type="hidden" name="dateMessage" value="<?php echo date('yy-m-d');?>">
     ...
     <?php 
       $message->getEnquiryId($_SESSION['studentNumber']);
     ?>
      </div>
      </div>
