                            ...
                            <div class="container-fluid">
                                          ...
                                          <div class="card-body">
                                                  <div class="tab-content p-0">
                                                                ...
                                                                <div class="row">
                                                                      <div class="col-md-12">  
                                                                      <form action="doctorform_update.php?ph=<?php echo $phone;?>" method="POST">
                                                                        ...
                                                                        <?php
                                                                          ...
                                                                          if( isset($_POST['doctor']) && $_POST['doctor']=="update" ){
                                                                              ...
                                                                              $doctor->update($_POST,$phone);
                                                                                //////$_GET['ph'] = $_POST['phoneNumber'];
                                                                                /////$phone = $_POST['phoneNumber'];
                                                                              if($doctor->update == TRUE){
                                                                        ?>
                                                                        ...
                                                                        ?>
                                                                          ...
                                                                          <input type="file" class="custom-file-input" id="exampleInputFile" name="imageD">
                                                                        ...
                                                                        <div class="form-group">
                                                                          ...
                                                                          <input type="name" class="form-control" name="nameD" id="name" placeholder="<?php $doctor->getDoctorId('nameD',$phone);?>">
                                                                        </div>
                                                                        <div class="form-group">
                                                                        ...
                                                                        <div class="form-group">
                                                                              ...
                                                                              <input type="email" class="form-control" name="email" id="email" placeholder="<?php $doctor->getDoctorId('email',$phone);?>">
                                                                        </div>
                                                                       
                                  
                                                                        <div class="form-group">
                                                                          <label for="exampleFormControlSelect2"> Phone Number</label>
                                                                          <input type="number" class="form-control" name="phoneNumber" id="telephone" placeholder="<?php $doctor->getDoctorId('phoneNumber',$phone);?>">
                                                                        </div>
                                                                       
                                                                        <div class="form-group">
                                                                              <label for="exampleInputEmail1">Country </label>
                                                                              <select class="form-control" name="country" size="1">
                                                                              <option selected="" value="<?php $doctor->getDoctorId('country',$phone);?>"><?php $doctor->getDoctorId('country',$phone);?></option>
                                                                        ...
                                                                        <div class="form-check">
                                                                          <div class="row">
                                                                            ...
                                                                            <input class="form-check-input" type="hidden" name="doctor" id="exampleRadios1" value="update">
