                              ...
                              <div class="row">
                                    ...
                                    <?php
                                        ...
                                        if( isset($_POST['schedule']) && $_POST['schedule']=="delete" ){
                                            ...
                                            $schedule->deleteSchedule($student);
                                        ?>
                                            <br/> <br/>
                                    ...
                                    ?>
                                            ...
                                            <?php 
                                              $schedule = new Schedule();
                                            ?>
                                           Mr. <?php $schedule->getScheduleId('patientName',$student); ?>, <br/>
                                        Do you really want to delete
                                        the appointment <?php $schedule->getScheduleId('appointmentDate',$student); ?> ?
                                                    ...
                                                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                              <form action="delete.php?st=<?php echo $student = $_GET['st'];?>" method="POST"> 
                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal" name="no" value="no">NO, Close</button>
                                                                <input type="submit" name="yes" value="Yes, Cancel"   class="btn btn-danger">
