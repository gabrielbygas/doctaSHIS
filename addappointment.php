      ...
      <div class="container-fluid">
                    ...
                    <div class="card-body">
                            <div class="tab-content p-0">
                                  ...
                                  <?php
                                //add
                                if( isset($_POST['addapp']) && $_POST['addapp']=="add" ){
                                          ...
                                          <div class="row">
                                                ...
                                                <?php $doctor->getDoctorName();?>                                      
                                                  ...
                                                  <div class="form-group">
                                                    ...
                                                    <input type="date" name="appointmentDate" class="form-control" id="appointmentDate" placeholder="Appointment Date">
                                                  </div>
                                                  <div class="form-group">
                                                    <label for="exampleFormControlSelect1">Time</label>
                                                    <select class="form-control" id="time" name="timeSchedule">
                                                    <option selected="">Pick the Time</option>
                                                    <option>09h30 - 10h30</option>
                                                    <option>10h45 - 11h45</option>
                                                    <option>11h55 - 12h55</option>
                                                    <option>13h00 - 14h00</option>
                                                    <option>14h10 - 15h10</option>
                                                    <option>15h20 - 16h20</option>
                                                  </select>
                                                  </div>
                                                  ...
                                                  <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="name" name="patientName" placeholder="Full name">
                                                  </div>
                                                  <div class="form-group">
                                                        <label for="exampleInputPassword1">Date of Birth</label>
                                                        <input type="date" class="form-control" id="appointmentDate" name="dateOfBirth" placeholder="Appointment Date">
                                                      </div>
            
                                                  <div class="form-group">
                                                    <label for="exampleFormControlSelect2"> Student Number</label>
                                                    <input type="number" class="form-control" id="telephone" name="studentNumber" placeholder="Student Number">
                                                  </div>
                                                  <div class="form-group">
                                                        <label for="exampleFormControlSelect2">Patient Mobile</label>
                                                        <input type="number" class="form-control" id="telephone" name="patientMobile" placeholder="Patient Mobile">
                                                      </div>
                                                  ...
                                                  <div class="form-check">
                                                    <div class="row">
                                                      ...
                                                      <input class="" type="hidden" name="addapp" value="add">
                                                    </div>
                                                  </div> 
                                                <br/>
